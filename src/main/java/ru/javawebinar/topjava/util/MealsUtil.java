...
public class MealsUtil {
    ...
    public static void main(String[] args) {
        ...
        List<MealTo> mealsTo = filteredByStreams(MEALS_LIST, LocalTime.of(7, 0), LocalTime.of(12, 0), 2000);
        mealsTo.forEach(System.out::println);
    }

    public static List<MealTo> getAllMeal(Collection<Meal> meals, int caloriesPerDay) {
